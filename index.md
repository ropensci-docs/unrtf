...
[![CRAN RStudio mirror
downloads](http://cranlogs.r-pkg.org/badges/unrtf)](http://cran.r-project.org/web/packages/unrtf/index.md)

> Extract Text from Rich Text Format (rtf) Documents

Wraps the [unrtf](https://www.gnu.org/software/unrtf/) utility to
...
[`unrtf()`](https://docs.ropensci.org/unrtf/reference/unrtf.md). It
takes either a local file path or a URL to a word document:
